"""
Example: How to call the bath-and-body-works actor using Apify API Client

For full documentation of the Apify Client for Python, see: https://docs.apify.com/api/client/python
For full documentation of the actor, see: https://apify.com/lexis-solutions/bath-and-body-works
...
def run_actor():
    """Run the bath-and-body-works actor and retrieve results."""
    ...
    actor_id = "lexis-solutions/bath-and-body-works"
